...
dt = fread("data/censoc_numident_demo_v1.csv")  ## demo Numident
...
my.dt <- dt[sex == "Male" & dyear %in% 1988:2005 & byear %in% cohorts &
            !is.na(edu)]  ## create sample
...
get.trunc.mean.gomp(my.alpha, .1, 71, 88)
## [1] 78.3002
get.trunc.mean.gomp(my.alpha*(.96), .1, 71, 88)
## [1] 78.41795
